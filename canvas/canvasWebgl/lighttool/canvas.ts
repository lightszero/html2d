...
namespace lighttool
{
    ...
    export class spriteCanvas
    {
        ...
        //draw tools
        drawTexture(texture: ITexture2D, rect: spriteRect, uvrect: spriteRect = spriteRect.one, color: spriteColor = spriteColor.white)
        {
            texture.draw(this.spriteBatcher, uvrect, rect, color);
        }
        drawTextureCustom(texture: ITexture2D, _mat: spriteMat, rect: spriteRect, uvrect: spriteRect = spriteRect.one, color: spriteColor = spriteColor.white, color2: spriteColor = spriteColor.white)
        {
