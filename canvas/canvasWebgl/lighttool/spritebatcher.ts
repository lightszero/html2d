...
namespace lighttool
{
    ...
    export class spriteBatcher
    {
        ...
        setMat(mat: spriteMat): void
        {
            ...
            if (this.shadercode.uniTex0 != null)
            {
                ...
                var tex = <ITexture2D>this.mat.tex0;
            ...
            if (this.shadercode.uniTex1 != null)
            {
                ...
                var tex = <ITexture2D>this.mat.tex1;
                this.webgl.bindTexture(this.webgl.TEXTURE_2D, tex == null ? null : tex.texture);
    ...
    {
        constructor(webgl: WebGLRenderingContext, width: number, height: number, format: textureformat = textureformat.RGBA, mipmap: boolean = false, linear: boolean = true)
        {
            this.webgl = webgl;
            this.format = format;
            this.width = width;
        ...
        private _loadData(mipmap: boolean, linear: boolean): void
        {
