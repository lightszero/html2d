var stateNavMesh = (function () {
    ...
    stateNavMesh.prototype.onInit = function (action) {
        var _this = this;
        this.action = action;
        this.canvas = action.canvas;
        lighttool.loadTool.loadText("navinfo/navinfo03.json.txt", function (txt, err) {
            _this.navinfo = lighttool.NavMesh.navMeshInfo.LoadMeshInfo(txt);
        });
        this.mat = new lighttool.spriteMat();
        this.mat.shader = "testC";
        this.mat.transparent = false;
    };
    stateNavMesh.prototype.onUpdate = function (delta) {
    ...
    stateNavMesh.prototype._drawLine = function (v1, v2, border, r, g, b) {
    ...
    stateNavMesh.prototype._drawPoly = function (poly, border, r, g, b) {
        //draw tri
    ...
    stateNavMesh.prototype.onDraw = function () {
        if (this.navinfo != null) {
    ...
    stateNavMesh.prototype.onExit = function () {
    };
    stateNavMesh.prototype.findpath = function () {
    ...
    stateNavMesh.prototype.onpointevent = function (e, x, y) {
...
//# sourceMappingURL=state_navmesh.js.map