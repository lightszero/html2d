...
namespace TMPro.EditorUtilities
{
    public class TMPro_FontPlugin
    {
        ...
        //static DebugLog deleLog = null;
        //public static void Init(DebugLog onLog)
        //{
        //    deleLog = onLog;
        //    IntPtr p = Marshal.GetFunctionPointerForDelegate(deleLog);
        //    //LinkDebug(p);
        ...
        [DllImport("TMPro_Plugin", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("TMPro_Plugin", CallingConvention = CallingConvention.Cdecl)]
        public static extern
            int Render_Characters(byte[] buffer, int buffer_width, int buffer_height, int character_padding, int[] asc_set, int char_count, FaceStyles style, float style_mod, bool autoSize, RenderModes renderMode, int method, ref FT_FaceInfo fontData, IntPtr Output);
